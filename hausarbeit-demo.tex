...
%% sets microtype for lualatex and pdflatex
\ifluatex, \ifLuaTeX, \ifPDFTeX, \ifpdftex
  \usepackage[final,tracking=smallcaps,expansion=alltext,protrusion=true]{microtype}%
  \SetTracking{encoding=*,shape=sc}{50}%

%% sets font for xetex and lualatex
\ifXeTeX, \ifxetex, \ifluatex, \ifLuaTeX
...
%%   \fi%
%%   \settowidth{\sectionnumwidth}{} %
%%   \settowidth{\subsectionnumwidth}{III)\ } %
%%   \settowidth{\subsubsectionnumwidth}{8)\ }%
%%   \settowidth{\subthreesectionnumwidth}{b)\ }%
%%   \settowidth{\subfoursectionnumwidth}{bb)\ }%
%%   \settowidth{\subfivesectionnumwidth}{(8)\ }%
%%   \settowidth{\subsixsectionnumwidth}{(b)\ }%
%%   \settowidth{\subsevensectionnumwidth}{(bb)\ } % geändert
